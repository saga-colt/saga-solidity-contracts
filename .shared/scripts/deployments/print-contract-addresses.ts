...
import { collectContractAddresses, renderContractAddressReport, ContractAddressFormat } from "../../lib/deployments/contracts-report";
...
async function main(): Promise<void> {
  ...
  try {
    ...
    const output = format === "json" ? JSON.stringify(report, null, 2) : renderContractAddressReport(report, "markdown");
