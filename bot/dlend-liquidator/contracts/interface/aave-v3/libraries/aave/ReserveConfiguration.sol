...
library ReserveConfiguration {
    // The configuration bitmap is used to efficiently store the reserve configuration
    // Please refer to DataTypes.ReserveConfigurationMap for the detailed explanation of the bitmap

    // Here some constants for easier configuration handling
