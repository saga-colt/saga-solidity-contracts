...
import { IUniswapV3LiquiditySwapAdapter } from "./interfaces/IUniswapV3LiquiditySwapAdapter.sol";
import { IERC20 } from "@openzeppelin/contracts/token/ERC20/IERC20.sol";

/**
 * @title UniswapV3LiquiditySwapAdapter
 * @notice Uniswap V3 Adapter to perform a swap of collateral from one asset to another
 ...
 */
contract UniswapV3LiquiditySwapAdapter is
    BaseUniswapV3SellAdapter,
    ReentrancyGuard,
    IAaveFlashLoanReceiver,
    IUniswapV3LiquiditySwapAdapter
{
    using SafeERC20 for IERC20;

    // unique identifier to track usage via flashloan events
    uint16 public constant REFERRER = 43980;
    ...
    /// @inheritdoc IUniswapV3LiquiditySwapAdapter
    ...
    function executeOperation(
        ...
        uint256 amountReceived = _sellOnUniswapV3(
            ...
            liquiditySwapParams.swapPath,
            liquiditySwapParams.deadline
        );
