...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  if (!config.uniswapRouter) {
    console.log("Uniswap Router not configured for this network. Skipping UniswapV3LiquiditySwapAdapter deployment.");
    return true;
  }
  ...
  // Deploy UniswapV3LiquiditySwapAdapter
  await deploy("UniswapV3LiquiditySwapAdapter", {
    from: deployer,
    args: [
...
func.id = "dLend:UniswapV3LiquiditySwapAdapter";
