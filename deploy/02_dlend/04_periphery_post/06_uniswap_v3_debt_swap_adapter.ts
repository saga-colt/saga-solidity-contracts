...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  if (!config.uniswapRouter) {
    console.log("Uniswap Router not configured for this network. Skipping UniswapV3DebtSwapAdapter deployment.");
    return true;
  }
  ...
  // Deploy UniswapV3DebtSwapAdapter
  await deploy("UniswapV3DebtSwapAdapter", {
    from: deployer,
    args: [
...
func.id = "dLend:UniswapV3DebtSwapAdapter";
