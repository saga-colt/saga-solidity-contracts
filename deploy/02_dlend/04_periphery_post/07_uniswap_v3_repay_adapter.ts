...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  if (!config.uniswapRouter) {
    console.log("Uniswap Router not configured for this network. Skipping UniswapV3RepayAdapter deployment.");
    return true;
  }
  ...
  // Deploy UniswapV3RepayAdapter
  await deploy("UniswapV3RepayAdapter", {
    from: deployer,
    args: [
...
func.id = "dLend:UniswapV3RepayAdapter";
