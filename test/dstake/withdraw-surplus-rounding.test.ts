...
import { DStakeToken, DStakeRouterDLend, DStakeCollateralVault, ERC20 } from "../../typechain-types";
...
describe("DStakeRouterDLend – surplus < 1 share withdraw DoS", function () {
  ...
  beforeEach(async function () {
    ...
    await router.connect(deployer).setDefaultDepositVaultAsset(vaultAssetAddress);
